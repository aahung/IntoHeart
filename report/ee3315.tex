\documentclass[10pt,a4paper,final,DIV=12]{scrartcl}
...
\begin{abstract}
Heart is a vital organ of human body, once it stops, no matter how strong, you are gone.\endnote{WebMD, The Truth About Heart Rate and Exercise, retrieved from http://www.webmd.com/fitness-exercise/features/the-truth-about-heart-rate-and-exercise on Feb 2, 2015 }  
...
\subsection{Non-Functional Requirements}
	\input{part/non_functional_require.tex}
\subsection{Architectural Design}
	\input{part/arch.tex}

\section{Configuration}
\subsection{Configuration}
	\input{part/config.tex}

\subsection{Known Issues}
	\input{part/issues.tex}

\subsection{User Manual}
	\input{part/user_manual.tex}
